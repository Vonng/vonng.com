...
我以前也用过语音转文字。比如之前 “[糊网站](https://mp.weixin.qq.com/s?__biz=MzU5ODAyNTM5Ng==&mid=2247489908&idx=1&sn=5bc755ee33be1fc868c200ed0c8f2df9&scene=21#wechat_redirect)”的时候，我用罗技 Options 鼠标驱动自带的语音转文字：按一下鼠标键实时听写，松开就停。能用，但很难“顺滑”：专业术语、英文单词识别不稳，经常乱飘，文件路径、命令行、代码片段这些东西，它基本听不懂。最致命的是纠错成本高，极其影响 Vibe Coding 的顺滑心流体验，所以用了一阵子就放弃了。
...
•**基础模式**：按住说话，松开开始转录并输入•**免提模式**：双击进入免提，你可以一直说；说完再按一下，让它开始转录
