---
title: "没错，数据库确实应该放入 K8s 里！"
date: 2023-12-07
authors: [fanux]
summary: >
  真理越辩越明，转载方老板对《数据库应该放入K8S里吗？》一文的争鸣，也期待鸣嵩的发言。我相信 SealOS 与 Kubeblocks 的 Day1 Setup 做的都不错，如果能补…
tags: [数据库, 容器化, 职业]
---

> 原作者：fanux · [微信公众号转载页](https://mp.weixin.qq.com/s/rpyNczx0AD_iseMMLioVjw)

昨天冯老板发了一篇文章探讨了为什么将数据库放入 K8S 中不是一个明智的选择：

[](https://mp.weixin.qq.com/s?__biz=MzU5ODAyNTM5Ng==&mid=2247486587&idx=1&sn=16521d6854711a4fe429464aeb2df6bd&scene=21#wechat_redirect)
...
这个时候发行版的优势就体现出来了，类似于 Linux 系统中，大多数人更倾向于使用 CentOS、Ubuntu 等发行版，而不是直接操作内核。我们也可以将 K8s 视为一种 “云内核”，如果你只是直接使用内核而不进行适当的定制和优化，可能会觉得它不够好用。因为内核本身只是提供了一个框架，很多功能和优化需要用户自己去实现。而 K8s 发行版则帮助用户解决了这一问题。例如，Sealos 可以帮你一键构建**包括高可用性集群、存储插件和数据库在内的完整系统**。这一切只需要简单的两条命令：
...
然后就没有然后了，一个包含高可用集群、存储插件和数据库的系统就诞生了。虽然 Ansible 可以帮助你解决安装问题，但它**无法处理运行时的自愈、多租户等问题**，而 on K8s 可以让数据库 as a Service。**第二：使用上的复杂度**
...
**加入 Sealos 开源社区**体验像个人电脑一样简单的云操作系统\**🏠官网链接**
...
[](https://mp.weixin.qq.com/s?__biz=Mzg5ODkwNTc2Ng==&mid=2247486695&idx=1&sn=ffd9e844a28603ffb501c22c4936ed20&chksm=c05a2f2ef72da638e9599d8e6b0975a8714b05b8d385cd2cfde209e416fe93f15a6afa4efe9a&scene=21#wechat_redirect)

稳啦，终于可以通过外网访问 Sealos 中的数据库了！

2023-12-05

![图片](04.webp)

[](https://mp.weixin.qq.com/s?__biz=Mzg5ODkwNTc2Ng==&mid=2247486674&idx=1&sn=35bc674a1e78c094ecf0582472bfe145&chksm=c05a2f1bf72da60df033b5e36ff29533e9503549d826bd8e72b5b834e04bf0e8885122916811&scene=21#wechat_redirect)

为什么说 Sealos 把 K8s 多租户做到了极致

2023-11-29

![图片](05.webp)

[](https://mp.weixin.qq.com/s?__biz=Mzg5ODkwNTc2Ng==&mid=2247486565&idx=1&sn=35455a4a98a0827b96c8c02e4f43d0f3&chksm=c05a2facf72da6ba19981771904158464ebf27628c07c13413ac1041c8a3b62e81de748465a1&scene=21#wechat_redirect)

一键部署 Sealos 私有云，企业 IT 升级秘籍
