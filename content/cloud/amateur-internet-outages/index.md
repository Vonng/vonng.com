...
authors: [ma-gong]
summary: >
  软件从业者们裸泳的屁股在潮水落下后露了出来 —— 请老老实实的补课，不要再吹牛逼了。
tags: [云计算, 故障复盘, PG管理]
---
...
当然，即使软件工程课程覆盖了可靠性理论，也不一定能触及学生。在上海交大计算机科学与技术系的课程表<sup>[10]</sup>中，《软件工程》竟然是选修课程，也就是说，一个优秀大学热门计算机专业的优秀毕业生，有可能会《移动互联网》或者《大数据处理》这些热门技能，但是很可能没有接受过最基本的工程教育。
