...
今天老冯起了一个新坑 —— PG 36计。这是一套关于 PostgreSQL 应用开发与运维管理的教程。今天刚刚把架子搭好，准备在后面不断填充内容。

![图片](01.webp)

说起这个企划，这本书还是当初 2017 年翻译完 DDIA 第一版后，我想搞的一个系列，PostgreSQL 教程，分应用，管理，内核三篇。[昨天刚把 DDIA 第二版的 Claude 机翻给弄好](https://mp.weixin.qq.com/s?__biz=MzU5ODAyNTM5Ng==&mid=2247490273&idx=1&sn=ca7daf541eaa9d505f48cf4c6740214c&scene=21#wechat_redirect)，一下子就想到了这本书，这本书就连目录结构都是照着 DDIA 弄的，原来的版本目录如下：
...
所以，我觉得是时候搞一个这样的教程了。这本书我会放在 https://pg36g.vonng.com<sup>[1]</sup> 上面，时不时的更新一下，争取在今年年底有一个基本完整的版本出来。因为 PG INTERNAL 和 PG14 INTERNAL 这两本内核的书已经有了，没必要单独再写一卷，所以这次就把 36 计 拆分成上卷 —— 应用开发和下卷 运维管理，每卷三篇18章。目录如下
